...
public class StringPairWritableOrigin implements WritableComparable<StringPairWritableOrigin> {
   ...
   */ 
  public StringPairWritableOrigin() {
   ...
   */ 
  public StringPairWritableOrigin(String left, String right) {
    this.left = left;
    this.right = right;    
  }
   ...
   */
  public int compareTo(StringPairWritableOrigin other) {
    int ret = 0;
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    StringPairWritableOrigin other = (StringPairWritableOrigin) obj;
    if (left == null) {
      if (other.left != null)
        return false;
